...
export default function Header() {
  return (
    <StickyWrapper>
      <div className="mx-auto flex w-full max-w-screen-xl flex-row items-center justify-between px-5 py-2 md:flex-col md:bg-inherit md:px-10 md:py-4 lg:flex-row xl:px-5">
